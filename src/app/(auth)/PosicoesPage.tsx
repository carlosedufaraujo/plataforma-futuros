...
export default function PosicoesPage({ selectedPeriod }: PosicoesPageProps) {
  const { positions, transactions, addPosition, addTransaction, updatePosition, closePosition, updateTransaction, deleteTransaction } = useData();
  const { 
    netPositions, 
    netStats, 
    formatNetQuantity, 
